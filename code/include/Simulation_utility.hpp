...
btRigidBody* createDynamicBody(float mass, const btTransform& startTransform, btCollisionShape* shape, GUIHelperInterface* m_guiHelper,  btVector4 color=btVector4(1,1,1,1),btScalar restitution=1.);

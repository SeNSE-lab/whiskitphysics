...
%   RatLab, FishLab and LIMS version, Released with Hartmann EDA toolbox v1
...
%   $Revision: 5.15 $  $Date: 2002/06/14 20:33:40 $
...
switch fix(12*rand)
    case 0,   a = 'why not?';
    case 1,   a = 'don''t ask!';
    case 2,   a = 'You should probably go ask an electric fish';
    case 3,   a = 'Go ask a cobot';
    case 4,   a = 'Be sure to take some time out every day to frisk some rat whiskers';
    case 5,   a = 'Because ultrasound reduces friction!';
...
switch fix(8*rand) 
    case 0,    a = 'The Fish Group';
    case 1,    a = 'The Haptics Group';
    case 2,    a = 'The HRH Group';
    case 3,    a = 'The Rat Whisker Group';
    case 4,    a = 'The ExoSkeleton Group';
    case 5,    a = 'The Cobot';
    case 6,    a = 'The Robotic Rat';
    case 7,    a = 'The Electric Fish';
    end
...
function a = noun
switch fix(6*rand)
    case 0,    a = 'NSF program officer';
    case 1,    a = 'fingertip';
    case 2,    a = 'electric fish';
    case 3,    a = 'engineer';
    case 4,    a = 'whisking rat';
    case 5,    a = 'kid';
end
...
switch fix(7*rand)
    case 0,    a = 'nonholonomic';
    case 1,    a = 'electrolocating';
    case 2,    a = 'whisking';
    case 3,    a = 'smart';
    case 4,    a = 'rich';
    case 5,    a = 'terrified';
...
switch fix(6*rand)
    case 0,    a = 'built a ribbon fin';
    case 1,    a = 'added nonholonomic constraints';
    case 2,    a = 'constructed a haptic field display';
    case 3,    a = 'fell off the snakeboard';
    case 4,    a = 'found humans to work with a robot';

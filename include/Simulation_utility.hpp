...
btRigidBody* createDynamicBody(float mass,float friction, const btTransform& startTransform, btCollisionShape* shape, GUIHelperInterface* m_guiHelper,  btVector4 color=btVector4(1,1,1,1));
